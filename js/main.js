...
Se ingresa un valorsuperior a 600, que representa una cantidad en minutos
...
*/ 
/*
let valorM=Number(prompt("Ingrese un valor en minutos para ser convertidos en lo que desee"));
console.log("El valor de los minutos ingresados es de:" + valorM);
*/
...
/* 
UNa fabrica de autos produce N autos
1-calcular la marca del auto y mostrar la suma total de autos de esa marca)peugeot mercedez fiat
2-color del auto celeste azul y rojo mostrar la cantidad de autos de cada color 

4luego decir cuanto se pago por el auto y a cuantas cuotas y calcular cuanto debe de pagar por cuota,
si son mas de 24 cuotas se le suma un 10% del valor de cada cuota, para el caso me un Mercez es un 15%
*/
